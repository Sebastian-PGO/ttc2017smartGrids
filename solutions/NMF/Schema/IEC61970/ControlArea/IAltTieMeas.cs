...
namespace TTC2017.SmartGrids.CIM.IEC61970.ControlArea
{
    ...
    /// <summary>
    /// The public interface for AltTieMeas
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(AltTieMeas))]
    [XmlDefaultImplementationTypeAttribute(typeof(AltTieMeas))]
    public interface IAltTieMeas : IModelElement, IElement
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TieFlowChanging;
        
        /// <summary>
        /// Gets fired when the TieFlow property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TieFlowChanged;
    }
}
