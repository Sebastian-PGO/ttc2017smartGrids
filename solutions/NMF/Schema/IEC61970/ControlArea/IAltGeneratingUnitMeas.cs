...
namespace TTC2017.SmartGrids.CIM.IEC61970.ControlArea
{
    ...
    /// <summary>
    /// The public interface for AltGeneratingUnitMeas
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(AltGeneratingUnitMeas))]
    [XmlDefaultImplementationTypeAttribute(typeof(AltGeneratingUnitMeas))]
    public interface IAltGeneratingUnitMeas : IModelElement, IElement
    {
        ...
        /// </summary>
        IControlAreaGeneratingUnit ControlAreaGeneratingUnit
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ControlAreaGeneratingUnitChanging;
        
        /// <summary>
        /// Gets fired when the ControlAreaGeneratingUnit property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ControlAreaGeneratingUnitChanged;
        
        /// <summary>
        /// Gets fired before the AnalogValue property changes its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> AnalogValueChanging;
        
        /// <summary>
        /// Gets fired when the AnalogValue property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> AnalogValueChanged;
    }
}
