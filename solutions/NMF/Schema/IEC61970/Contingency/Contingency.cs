...
namespace TTC2017.SmartGrids.CIM.IEC61970.Contingency
{
    ...
    public partial class Contingency : IdentifiedObject, IContingency, IModelElement
    {
        ...
        private void ContingencyConstraintLimitCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ContingencyElementCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
