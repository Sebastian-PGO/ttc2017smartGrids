...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.GenerationDynamics
{
    ...
    public class TurbineTypeConverter : System.ComponentModel.TypeConverter
    {
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            if ((value == null))
            {
                return default(TurbineType);
            }
            string valueString = value.ToString();
            if ((valueString == "pelton"))
            {
                return TurbineType.Pelton;
            }
            if ((valueString == "francis"))
            {
                return TurbineType.Francis;
            }
            if ((valueString == "kaplan"))
            {
