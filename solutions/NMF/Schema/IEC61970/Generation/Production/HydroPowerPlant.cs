...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class HydroPowerPlant : PowerSystemResource, IHydroPowerPlant, IModelElement
    {
        ...
        private void HydroGeneratingUnitsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void HydroPumpsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
