...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the TailbayLossCurve class
    /// </summary>
    [XmlNamespaceAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#Production")]
    [XmlNamespacePrefixAttribute("cimProduction")]
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/Tailbay" +
        "LossCurve")]
    [DebuggerDisplayAttribute("TailbayLossCurve {UUID}")]
    public partial class TailbayLossCurve : Curve, ITailbayLossCurve, IModelElement
    {
        ...
        [XmlOppositeAttribute("TailbayLossCurve")]
        public virtual IHydroGeneratingUnit HydroGeneratingUnit
        {
            ...
            set
            {
                if ((this._hydroGeneratingUnit != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.TailbayLossCurve.Remove(this);
                        old.Deleted -= this.OnResetHydroGeneratingUnit;
                    }
                    if ((value != null))
                    {
                        value.TailbayLossCurve.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new TailbayLossCurveReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/Tailbay" +
                            "LossCurve")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TailbayLossCurve.ClassInstance)).Resolve("HydroGeneratingUnit")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the TailbayLossCurve class
        /// </summary>
        public class TailbayLossCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private TailbayLossCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public TailbayLossCurveReferencedElementsCollection(TailbayLossCurve parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class HydroGeneratingUnitProxy : ModelPropertyChange<ITailbayLossCurve, IHydroGeneratingUnit>
        {
            ...
            public HydroGeneratingUnitProxy(ITailbayLossCurve modelElement) : 
