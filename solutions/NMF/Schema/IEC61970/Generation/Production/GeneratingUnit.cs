...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class GeneratingUnit : Equipment, IGeneratingUnit, IModelElement
    {
        ...
        private void ControlAreaGeneratingUnitCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void GrossToNetActivePowerCurvesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void GenUnitOpCostCurvesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
