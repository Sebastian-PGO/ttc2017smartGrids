...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The public interface for StartMainFuelCurve
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(StartMainFuelCurve))]
    [XmlDefaultImplementationTypeAttribute(typeof(StartMainFuelCurve))]
    public interface IStartMainFuelCurve : IModelElement, ICurve
    {
        
        /// <summary>
        /// The mainFuelType property
        /// </summary>
        Nullable<FuelType> MainFuelType
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> MainFuelTypeChanging;
        
        /// <summary>
        /// Gets fired when the MainFuelType property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> MainFuelTypeChanged;
