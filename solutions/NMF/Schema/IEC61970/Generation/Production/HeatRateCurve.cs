...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class HeatRateCurve : Curve, IHeatRateCurve, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(HeatRateCurve.ClassInstance)).Resolve("isNetGrossP")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(HeatRateCurve.ClassInstance)).Resolve("ThermalGeneratingUnit")));
        }
