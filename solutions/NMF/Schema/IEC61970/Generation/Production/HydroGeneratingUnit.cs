...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class HydroGeneratingUnit : GeneratingUnit, IHydroGeneratingUnit, IModelElement
    {
        ...
        private void TailbayLossCurveCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void HydroGeneratingEfficiencyCurvesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
