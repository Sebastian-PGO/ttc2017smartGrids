...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The public interface for EmissionCurve
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(EmissionCurve))]
    [XmlDefaultImplementationTypeAttribute(typeof(EmissionCurve))]
    public interface IEmissionCurve : IModelElement, ICurve
    {
        
        /// <summary>
        /// The emissionContent property
        /// </summary>
        float EmissionContent
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> EmissionContentChanging;
        
        /// <summary>
        /// Gets fired when the EmissionContent property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> EmissionContentChanged;
