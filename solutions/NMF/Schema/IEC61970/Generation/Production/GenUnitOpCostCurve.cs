...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the GenUnitOpCostCurve class
    /// </summary>
    ...
    public partial class GenUnitOpCostCurve : Curve, IGenUnitOpCostCurve, IModelElement
    {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("GenUnitOpCostCurves")]
        public virtual IGeneratingUnit GeneratingUnit
        {
            ...
            set
            {
                if ((this._generatingUnit != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.GenUnitOpCostCurves.Remove(this);
                        old.Deleted -= this.OnResetGeneratingUnit;
                    }
                    if ((value != null))
                    {
                        value.GenUnitOpCostCurves.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new GenUnitOpCostCurveReferencedElementsCollection(this));
            }
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the GenUnitOpCostCurve class
        /// </summary>
        public class GenUnitOpCostCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private GenUnitOpCostCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public GenUnitOpCostCurveReferencedElementsCollection(GenUnitOpCostCurve parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class IsNetGrossPProxy : ModelPropertyChange<IGenUnitOpCostCurve, bool>
        {
        ...
        /// </summary>
        private sealed class GeneratingUnitProxy : ModelPropertyChange<IGenUnitOpCostCurve, IGeneratingUnit>
        {
