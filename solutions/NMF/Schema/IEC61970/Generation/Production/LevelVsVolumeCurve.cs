...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the LevelVsVolumeCurve class
    /// </summary>
    [XmlNamespaceAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#Production")]
    [XmlNamespacePrefixAttribute("cimProduction")]
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/LevelVs" +
        "VolumeCurve")]
    [DebuggerDisplayAttribute("LevelVsVolumeCurve {UUID}")]
    public partial class LevelVsVolumeCurve : Curve, ILevelVsVolumeCurve, IModelElement
    {
        ...
        [XmlOppositeAttribute("LevelVsVolumeCurves")]
        public virtual IReservoir Reservoir
        {
            ...
            set
            {
                if ((this._reservoir != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.LevelVsVolumeCurves.Remove(this);
                        old.Deleted -= this.OnResetReservoir;
                    }
                    if ((value != null))
                    {
                        value.LevelVsVolumeCurves.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new LevelVsVolumeCurveReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/LevelVs" +
                            "VolumeCurve")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(LevelVsVolumeCurve.ClassInstance)).Resolve("Reservoir")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the LevelVsVolumeCurve class
        /// </summary>
        public class LevelVsVolumeCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private LevelVsVolumeCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public LevelVsVolumeCurveReferencedElementsCollection(LevelVsVolumeCurve parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class ReservoirProxy : ModelPropertyChange<ILevelVsVolumeCurve, IReservoir>
        {
            ...
            public ReservoirProxy(ILevelVsVolumeCurve modelElement) : 
