...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class ThermalGeneratingUnit : GeneratingUnit, IThermalGeneratingUnit, IModelElement
    {
        ...
        private void EmissionCurvesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FossilFuelsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void EmmissionAccountsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
