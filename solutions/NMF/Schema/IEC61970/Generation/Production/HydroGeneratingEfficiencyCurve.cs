...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    public partial class HydroGeneratingEfficiencyCurve : Curve, IHydroGeneratingEfficiencyCurve, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(HydroGeneratingEfficiencyCurve.ClassInstance)).Resolve("HydroGeneratingUnit")));
        }
