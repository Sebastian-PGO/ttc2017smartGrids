...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the IncrementalHeatRateCurve class
    /// </summary>
    ...
    public partial class IncrementalHeatRateCurve : Curve, IIncrementalHeatRateCurve, IModelElement
    {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("IncrementalHeatRateCurve")]
        public virtual IThermalGeneratingUnit ThermalGeneratingUnit
        {
            ...
            set
            {
                if ((this._thermalGeneratingUnit != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.IncrementalHeatRateCurve = null;
                        old.Deleted -= this.OnResetThermalGeneratingUnit;
                    }
                    if ((value != null))
                    {
                        value.IncrementalHeatRateCurve = this;
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new IncrementalHeatRateCurveReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/Increme" +
                            "ntalHeatRateCurve")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the IncrementalHeatRateCurve class
        /// </summary>
        public class IncrementalHeatRateCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private IncrementalHeatRateCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public IncrementalHeatRateCurveReferencedElementsCollection(IncrementalHeatRateCurve parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class IsNetGrossPProxy : ModelPropertyChange<IIncrementalHeatRateCurve, bool>
        {
        ...
        /// </summary>
        private sealed class ThermalGeneratingUnitProxy : ModelPropertyChange<IIncrementalHeatRateCurve, IThermalGeneratingUnit>
        {
