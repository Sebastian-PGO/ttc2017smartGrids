...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the EmissionCurve class
    /// </summary>
    ...
    public partial class EmissionCurve : Curve, IEmissionCurve, IModelElement
    {
        ...
        /// <summary>
        /// The backing field for the EmissionContent property
        /// </summary>
        ...
        /// <summary>
        /// The emissionContent property
        /// </summary>
        [XmlElementNameAttribute("emissionContent")]
        [XmlAttributeAttribute(true)]
        public virtual float EmissionContent
        {
            get
            {
                return this._emissionContent;
            }
            set
            {
                if ((this._emissionContent != value))
                {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("EmissionCurves")]
        public virtual IThermalGeneratingUnit ThermalGeneratingUnit
        {
            ...
            set
            {
                if ((this._thermalGeneratingUnit != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.EmissionCurves.Remove(this);
                        old.Deleted -= this.OnResetThermalGeneratingUnit;
                    }
                    if ((value != null))
                    {
                        value.EmissionCurves.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new EmissionCurveReferencedElementsCollection(this));
            }
        }
        ...
        /// <summary>
        /// Gets fired before the EmissionContent property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> EmissionContentChanging;
        
        /// <summary>
        /// Gets fired when the EmissionContent property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> EmissionContentChanged;
        ...
        protected virtual void OnEmissionContentChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.EmissionContentChanging;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the EmissionContentChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnEmissionContentChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.EmissionContentChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((attribute == "EMISSIONCONTENT"))
            {
                return this.EmissionContent;
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "EMISSIONCONTENT"))
            {
                this.EmissionContent = ((float)(value));
                return;
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the EmissionCurve class
        /// </summary>
        public class EmissionCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private EmissionCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public EmissionCurveReferencedElementsCollection(EmissionCurve parent)
            {
                this._parent = parent;
            }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the emissionContent property
        /// </summary>
        private sealed class EmissionContentProxy : ModelPropertyChange<IEmissionCurve, float>
        {
            ...
            public override float Value
            {
                get
                {
                    return this.ModelElement.EmissionContent;
                }
                set
                {
        ...
        /// </summary>
        private sealed class IsNetGrossPProxy : ModelPropertyChange<IEmissionCurve, bool>
        {
        ...
        /// </summary>
        private sealed class EmissionTypeProxy : ModelPropertyChange<IEmissionCurve, Nullable<EmissionType>>
        {
        ...
        /// </summary>
        private sealed class ThermalGeneratingUnitProxy : ModelPropertyChange<IEmissionCurve, IThermalGeneratingUnit>
        {
