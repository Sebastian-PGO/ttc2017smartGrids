...
namespace TTC2017.SmartGrids.CIM.IEC61970.Generation.Production
{
    ...
    /// <summary>
    /// The default implementation of the GenUnitOpSchedule class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/GenUnit" +
        "OpSchedule")]
    [DebuggerDisplayAttribute("GenUnitOpSchedule {UUID}")]
    public partial class GenUnitOpSchedule : RegularIntervalSchedule, IGenUnitOpSchedule, IModelElement
    {
        ...
        [XmlOppositeAttribute("GenUnitOpSchedule")]
        public virtual IGeneratingUnit GeneratingUnit
        {
            ...
            set
            {
                if ((this._generatingUnit != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.GenUnitOpSchedule = null;
                        old.Deleted -= this.OnResetGeneratingUnit;
                    }
                    if ((value != null))
                    {
                        value.GenUnitOpSchedule = this;
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new GenUnitOpScheduleReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Generation/Production/GenUnit" +
                            "OpSchedule")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(GenUnitOpSchedule.ClassInstance)).Resolve("GeneratingUnit")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the GenUnitOpSchedule class
        /// </summary>
        public class GenUnitOpScheduleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private GenUnitOpSchedule _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public GenUnitOpScheduleReferencedElementsCollection(GenUnitOpSchedule parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class GeneratingUnitProxy : ModelPropertyChange<IGenUnitOpSchedule, IGeneratingUnit>
        {
            ...
            public GeneratingUnitProxy(IGenUnitOpSchedule modelElement) : 
