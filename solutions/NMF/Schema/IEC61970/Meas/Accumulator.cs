...
namespace TTC2017.SmartGrids.CIM.IEC61970.Meas
{
    ...
    public partial class Accumulator : Measurement, IAccumulator, IModelElement
    {
        ...
        private void AccumulatorValuesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void LimitSetsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
