...
namespace TTC2017.SmartGrids.CIM.IEC61970.Meas
{
    ...
    /// <summary>
    /// The default implementation of the AccumulatorValue class
    /// </summary>
    ...
    public partial class AccumulatorValue : MeasurementValue, IAccumulatorValue, IModelElement
    {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("AccumulatorValues")]
        public virtual IAccumulator Accumulator
        {
            get
            {
            ...
            set
            {
                if ((this._accumulator != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.AccumulatorValues.Remove(this);
                        old.Deleted -= this.OnResetAccumulator;
                    }
                    if ((value != null))
                    {
                        value.AccumulatorValues.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new AccumulatorValueReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Meas/AccumulatorValue")));
                }
        ...
        /// <summary>
        /// Gets fired before the Accumulator property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> AccumulatorChanging;
        
        /// <summary>
        /// Gets fired when the Accumulator property changed its value
        /// </summary>
        ...
        /// <summary>
        /// Raises the AccumulatorChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnAccumulatorChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.AccumulatorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the Accumulator property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetAccumulator(object sender, System.EventArgs eventArgs)
        {
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Accumulator = ((IAccumulator)(value));
                return;
            }
            if ((feature == "VALUE"))
            {
        ...
        {
            if ((attribute == "Accumulator"))
            {
                return new AccumulatorProxy(this);
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the AccumulatorValue class
        /// </summary>
        public class AccumulatorValueReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private AccumulatorValue _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public AccumulatorValueReferencedElementsCollection(AccumulatorValue parent)
            {
                this._parent = parent;
            }
            ...
            {
                this._parent.AccumulatorChanged += this.PropagateValueChanges;
            }
            ...
            {
                if ((item == this._parent.Accumulator))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.Accumulator != null))
                {
                    array[arrayIndex] = this._parent.Accumulator;
            ...
            {
                if ((this._parent.Accumulator == item))
                {
                    this._parent.Accumulator = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Accumulator).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class ValueProxy : ModelPropertyChange<IAccumulatorValue, int>
        {
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the Accumulator property
        /// </summary>
        private sealed class AccumulatorProxy : ModelPropertyChange<IAccumulatorValue, IAccumulator>
        {
            ...
            /// Gets or sets the value of this expression
            /// </summary>
            public override IAccumulator Value
            {
                get
                {
                    return this.ModelElement.Accumulator;
                }
                set
                {
