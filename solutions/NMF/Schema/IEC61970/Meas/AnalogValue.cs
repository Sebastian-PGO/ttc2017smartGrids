...
namespace TTC2017.SmartGrids.CIM.IEC61970.Meas
{
    ...
    public partial class AnalogValue : MeasurementValue, IAnalogValue, IModelElement
    {
        ...
        private void AltGeneratingUnitCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AltTieMeasCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
