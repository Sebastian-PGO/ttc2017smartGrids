...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfCommon
{
    ...
    /// <summary>
    /// The public interface for MarketRole
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(MarketRole))]
    [XmlDefaultImplementationTypeAttribute(typeof(MarketRole))]
    public interface IMarketRole : IModelElement, IIdentifiedObject
    {
        
        /// <summary>
        /// The kind property
        /// </summary>
        Nullable<MarketRoleKind> Kind
        {
            get;
            set;
        }
        ...
        /// </summary>
        IOrderedSetExpression<IOrganisation> Organisations
        {
            get;
        }
