...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfCommon
{
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfCommon/Role")]
    [DebuggerDisplayAttribute("Role {UUID}")]
    public partial class Role : IdentifiedObject, IRole, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new RoleReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfCommon/Role")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Role.ClassInstance)).Resolve("category")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Role.ClassInstance)).Resolve("status")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the Role class
        /// </summary>
        public class RoleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public RoleReferencedElementsCollection(Role parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class CategoryProxy : ModelPropertyChange<IRole, string>
        {
            ...
            public CategoryProxy(IRole modelElement) : 
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IRole, IStatus>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StatusProxy(IRole modelElement) : 
