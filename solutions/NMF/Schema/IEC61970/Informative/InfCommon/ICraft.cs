...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfCommon
{
    ...
    /// <summary>
    /// The public interface for Craft
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Craft))]
    [XmlDefaultImplementationTypeAttribute(typeof(Craft))]
    public interface ICraft : IModelElement, IIdentifiedObject
    {
