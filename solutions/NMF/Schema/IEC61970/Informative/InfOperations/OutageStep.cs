...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfOperations
{
    ...
    public partial class OutageStep : IdentifiedObject, IOutageStep, IModelElement
    {
        ...
        private void OutageCodesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ConductingEquipmentRolesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
