...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfOperations
{
    ...
    /// <summary>
    /// The public interface for PlannedOutage
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(PlannedOutage))]
    [XmlDefaultImplementationTypeAttribute(typeof(PlannedOutage))]
    public interface IPlannedOutage : IModelElement, IDocument
    {
        
        /// <summary>
        /// The kind property
        /// </summary>
        Nullable<OutageKind> Kind
        {
            get;
            set;
        }
        ...
        /// </summary>
        IOrderedSetExpression<IOutageSchedule> OutageSchedules
        {
            get;
        }
