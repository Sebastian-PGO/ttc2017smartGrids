...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfGMLSupport
{
    ...
    /// <summary>
    /// The public interface for GmlPointSymbol
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(GmlPointSymbol))]
    [XmlDefaultImplementationTypeAttribute(typeof(GmlPointSymbol))]
    public interface IGmlPointSymbol : IModelElement, IGmlSymbol
    {
        
        /// <summary>
        /// The GmlGraphic property
        /// </summary>
        IGmlGraphic GmlGraphic
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> GmlGraphicChanging;
        
        /// <summary>
        /// Gets fired when the GmlGraphic property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> GmlGraphicChanged;
