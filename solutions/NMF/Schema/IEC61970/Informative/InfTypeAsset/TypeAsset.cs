...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfTypeAsset
{
    ...
    public partial class TypeAsset : IdentifiedObject, ITypeAsset, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ErpInventoryIssuesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AssetModelsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
