...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfTypeAsset
{
    ...
    /// <summary>
    /// The default implementation of the ElectricalTypeAsset class
    /// </summary>
    ...
    public partial class ElectricalTypeAsset : TTC2017.SmartGrids.CIM.IEC61970.Informative.InfTypeAsset.TypeAsset, IElectricalTypeAsset, IModelElement
    {
        ...
        /// </summary>
        private ElectricalTypeAssetElectricalInfosCollection _electricalInfos;
        
        private static IClass _classInstance;
        
        public ElectricalTypeAsset()
        {
            this._electricalInfos = new ElectricalTypeAssetElectricalInfosCollection(this);
        ...
        [XmlOppositeAttribute("ElectricalTypeAssets")]
        [ConstantAttribute()]
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ElectricalTypeAssetReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfTypeAsset/Elec" +
                            "tricalTypeAsset")));
                }
        ...
        private void ElectricalInfosCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <summary>
        /// The collection class to to represent the children of the ElectricalTypeAsset class
        /// </summary>
        public class ElectricalTypeAssetReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ElectricalTypeAsset _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ElectricalTypeAssetReferencedElementsCollection(ElectricalTypeAsset parent)
            {
                this._parent = parent;
            }
