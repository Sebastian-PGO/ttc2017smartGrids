...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    /// <summary>
    /// The default implementation of the ErpPersonnel class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfERPSupport/Erp" +
        "Personnel")]
    [DebuggerDisplayAttribute("ErpPersonnel {UUID}")]
    public partial class ErpPersonnel : IdentifiedObject, IErpPersonnel, IModelElement
    {
        ...
        /// </summary>
        private ErpPersonnelErpPersonsCollection _erpPersons;
        
        private static IClass _classInstance;
        
        public ErpPersonnel()
        {
            this._erpPersons = new ErpPersonnelErpPersonsCollection(this);
        ...
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ErpPersonnel")]
        [ConstantAttribute()]
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ErpPersonnelReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpPersonnel.ClassInstance)).Resolve("status")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpPersonnel.ClassInstance)).Resolve("ErpPersons")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ErpPersonnel class
        /// </summary>
        public class ErpPersonnelReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ErpPersonnel _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ErpPersonnelReferencedElementsCollection(ErpPersonnel parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Status).Concat(this._parent.ErpPersons).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IErpPersonnel, IStatus>
        {
            ...
            public StatusProxy(IErpPersonnel modelElement) : 
