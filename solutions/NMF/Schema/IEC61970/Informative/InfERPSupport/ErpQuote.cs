...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    /// <summary>
    /// The default implementation of the ErpQuote class
    /// </summary>
    ...
    public partial class ErpQuote : Document, IErpQuote, IModelElement
    {
        ...
        /// </summary>
        private ErpQuoteErpQuoteLineItemsCollection _erpQuoteLineItems;
        
        private static IClass _classInstance;
        
        public ErpQuote()
        {
            this._erpQuoteLineItems = new ErpQuoteErpQuoteLineItemsCollection(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ErpQuoteReferencedElementsCollection(this));
            }
        }
        ...
        private void ErpQuoteLineItemsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <summary>
        /// The collection class to to represent the children of the ErpQuote class
        /// </summary>
        public class ErpQuoteReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ErpQuote _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ErpQuoteReferencedElementsCollection(ErpQuote parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ErpQuoteLineItems).GetEnumerator();
            }
        }
    }
}
