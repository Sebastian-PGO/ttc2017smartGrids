...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    /// <summary>
    /// The default implementation of the ErpItemMaster class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfERPSupport/Erp" +
        "ItemMaster")]
    [DebuggerDisplayAttribute("ErpItemMaster {UUID}")]
    public partial class ErpItemMaster : IdentifiedObject, IErpItemMaster, IModelElement
    {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ErpItemMaster")]
        public virtual IAsset Asset
        {
            ...
            set
            {
                if ((this._asset != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.ErpItemMaster = null;
                        old.Deleted -= this.OnResetAsset;
                    }
                    if ((value != null))
                    {
                        value.ErpItemMaster = this;
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ErpItemMasterReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpItemMaster.ClassInstance)).Resolve("status")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpItemMaster.ClassInstance)).Resolve("Asset")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ErpItemMaster class
        /// </summary>
        public class ErpItemMasterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ErpItemMaster _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ErpItemMasterReferencedElementsCollection(ErpItemMaster parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Status).Concat(this._parent.Asset).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IErpItemMaster, IStatus>
        {
            ...
            public StatusProxy(IErpItemMaster modelElement) : 
        ...
        /// </summary>
        private sealed class AssetProxy : ModelPropertyChange<IErpItemMaster, IAsset>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public AssetProxy(IErpItemMaster modelElement) : 
