...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    /// <summary>
    /// The default implementation of the ErpInventory class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfERPSupport/Erp" +
        "Inventory")]
    [DebuggerDisplayAttribute("ErpInventory {UUID}")]
    public partial class ErpInventory : IdentifiedObject, IErpInventory, IModelElement
    {
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ErpInventory")]
        public virtual IAsset Asset
        {
            ...
            set
            {
                if ((this._asset != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.ErpInventory = null;
                        old.Deleted -= this.OnResetAsset;
                    }
                    if ((value != null))
                    {
                        value.ErpInventory = this;
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ErpInventoryReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpInventory.ClassInstance)).Resolve("status")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpInventory.ClassInstance)).Resolve("Asset")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ErpInventory class
        /// </summary>
        public class ErpInventoryReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ErpInventory _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ErpInventoryReferencedElementsCollection(ErpInventory parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IErpInventory, IStatus>
        {
            ...
            public StatusProxy(IErpInventory modelElement) : 
        ...
        /// </summary>
        private sealed class AssetProxy : ModelPropertyChange<IErpInventory, IAsset>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public AssetProxy(IErpInventory modelElement) : 
