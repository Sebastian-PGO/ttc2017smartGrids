...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    public partial class ErpJournalEntry : IdentifiedObject, IErpJournalEntry, IModelElement
    {
        ...
        private void CostTypesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ErpPayableLineItemsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ErpRecLineItemsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
