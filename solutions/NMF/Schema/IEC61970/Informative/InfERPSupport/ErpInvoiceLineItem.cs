...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    public partial class ErpInvoiceLineItem : Document, IErpInvoiceLineItem, IModelElement
    {
        ...
        private void SettlementsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ComponentErpInvoiceLineItemsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
