...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfERPSupport
{
    ...
    /// <summary>
    /// The default implementation of the ErpPayableLineItem class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfERPSupport/Erp" +
        "PayableLineItem")]
    [DebuggerDisplayAttribute("ErpPayableLineItem {UUID}")]
    public partial class ErpPayableLineItem : IdentifiedObject, IErpPayableLineItem, IModelElement
    {
        ...
        /// </summary>
        private ErpPayableLineItemErpPaymentsCollection _erpPayments;
        
        private static Lazy<ITypedElement> _erpPayableReference = new Lazy<ITypedElement>(RetrieveErpPayableReference);
        
        /// <summary>
        /// The backing field for the ErpPayable property
        /// </summary>
        private IErpPayable _erpPayable;
        ...
        /// </summary>
        private ErpPayableLineItemErpJournalEntriesCollection _erpJournalEntries;
        ...
        {
            this._erpPayments = new ErpPayableLineItemErpPaymentsCollection(this);
            ...
            this._erpJournalEntries = new ErpPayableLineItemErpJournalEntriesCollection(this);
        ...
        [XmlOppositeAttribute("ErpPayableLineItem")]
        public virtual IErpInvoiceLineItem ErpInvoiceLineItem
        {
            ...
            set
            {
                if ((this._erpInvoiceLineItem != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.ErpPayableLineItem = null;
                        old.Deleted -= this.OnResetErpInvoiceLineItem;
                    }
                    if ((value != null))
                    {
                        value.ErpPayableLineItem = this;
        ...
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ErpPayableLineItems")]
        [ConstantAttribute()]
        ...
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ErpPayableLineItems")]
        public virtual IErpPayable ErpPayable
        {
            get
            {
                return this._erpPayable;
            }
            set
            {
                if ((this._erpPayable != value))
                {
                    IErpPayable old = this._erpPayable;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnErpPayableChanging(e);
                    this.OnPropertyChanging("ErpPayable", e, _erpPayableReference);
                    this._erpPayable = value;
                    if ((old != null))
                    {
                        old.ErpPayableLineItems.Remove(this);
                        old.Deleted -= this.OnResetErpPayable;
                    }
                    if ((value != null))
                    {
                        value.ErpPayableLineItems.Add(this);
                        value.Deleted += this.OnResetErpPayable;
                    }
                    this.OnErpPayableChanged(e);
                    this.OnPropertyChanged("ErpPayable", e, _erpPayableReference);
                }
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ErpPayableLineItemReferencedElementsCollection(this));
            }
        }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ErpPayableChanging;
        
        /// <summary>
        /// Gets fired when the ErpPayable property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ErpPayableChanged;
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpPayableLineItem.ClassInstance)).Resolve("ErpInvoiceLineItem")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpPayableLineItem.ClassInstance)).Resolve("ErpPayments")));
        }
        ...
        private void ErpPaymentsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        private static ITypedElement RetrieveErpPayableReference()
        {
            return ((ITypedElement)(((ModelElement)(ErpPayableLineItem.ClassInstance)).Resolve("ErpPayable")));
        }
        
        /// <summary>
        /// Raises the ErpPayableChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnErpPayableChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ErpPayableChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ErpPayableChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnErpPayableChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ErpPayableChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the ErpPayable property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetErpPayable(object sender, System.EventArgs eventArgs)
        {
            this.ErpPayable = null;
        }
        
        private static ITypedElement RetrieveErpJournalEntriesReference()
        {
            return ((ITypedElement)(((ModelElement)(ErpPayableLineItem.ClassInstance)).Resolve("ErpJournalEntries")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ErpPayableLineItem.ClassInstance)).Resolve("status")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "ERPPAYABLE"))
            {
                this.ErpPayable = ((IErpPayable)(value));
                return;
            }
            if ((feature == "STATUS"))
            {
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            ...
            if ((attribute == "ErpPayable"))
            {
                return new ErpPayableProxy(this);
            }
            if ((attribute == "Status"))
            {
        ...
        /// <summary>
        /// The collection class to to represent the children of the ErpPayableLineItem class
        /// </summary>
        public class ErpPayableLineItemReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ErpPayableLineItem _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ErpPayableLineItemReferencedElementsCollection(ErpPayableLineItem parent)
            {
                this._parent = parent;
            }
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.ErpPayableChanged += this.PropagateValueChanges;
            ...
            public override bool Contains(IModelElement item)
            {
                ...
                if ((item == this._parent.ErpPayable))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                if ((this._parent.ErpPayable != null))
                {
                    array[arrayIndex] = this._parent.ErpPayable;
                    arrayIndex = (arrayIndex + 1);
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ErpInvoiceLineItem).Concat(this._parent.ErpPayments).Concat(this._parent.ErpPayable).Concat(this._parent.ErpJournalEntries).Concat(this._parent.Status).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class ErpInvoiceLineItemProxy : ModelPropertyChange<IErpPayableLineItem, IErpInvoiceLineItem>
        {
            ...
            public ErpInvoiceLineItemProxy(IErpPayableLineItem modelElement) : 
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the ErpPayable property
        /// </summary>
        private sealed class ErpPayableProxy : ModelPropertyChange<IErpPayableLineItem, IErpPayable>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ErpPayableProxy(IErpPayableLineItem modelElement) : 
                    base(modelElement, "ErpPayable")
            {
            }
            ...
            /// Gets or sets the value of this expression
            /// </summary>
            public override IErpPayable Value
            {
                get
                {
                    return this.ModelElement.ErpPayable;
                }
                set
                {
                    this.ModelElement.ErpPayable = value;
                }
            }
        }
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IErpPayableLineItem, IStatus>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StatusProxy(IErpPayableLineItem modelElement) : 
