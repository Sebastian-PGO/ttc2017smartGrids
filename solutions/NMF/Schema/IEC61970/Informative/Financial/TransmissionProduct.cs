...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Financial
{
    ...
    public partial class TransmissionProduct : IdentifiedObject, ITransmissionProduct, IModelElement
    {
        ...
        private void LocationForCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void OffersCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
