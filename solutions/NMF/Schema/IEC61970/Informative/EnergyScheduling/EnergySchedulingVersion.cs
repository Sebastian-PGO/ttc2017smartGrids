...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.EnergyScheduling
{
    ...
    public partial class EnergySchedulingVersion : Element, IEnergySchedulingVersion, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(EnergySchedulingVersion.ClassInstance)).Resolve("date")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(EnergySchedulingVersion.ClassInstance)).Resolve("version")));
        }
