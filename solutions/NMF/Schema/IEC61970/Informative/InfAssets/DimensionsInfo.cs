...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfAssets
{
    ...
    public partial class DimensionsInfo : IdentifiedObject, IDimensionsInfo, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void SpecificationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AssetInfosCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
