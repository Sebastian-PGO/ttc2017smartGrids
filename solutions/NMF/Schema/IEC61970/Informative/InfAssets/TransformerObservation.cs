...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfAssets
{
    ...
    public partial class TransformerObservation : IdentifiedObject, ITransformerObservation, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void BushingInsultationPFsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void WindingInsulationPFsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
