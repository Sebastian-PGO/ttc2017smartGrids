...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfAssets
{
    ...
    public partial class TransformerAsset : Asset, ITransformerAsset, IModelElement
    {
        ...
        private void PowerRatingsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void TransformerObservationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
