...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfAssets
{
    ...
    public partial class ElectricalInfo : AssetInfo, IElectricalInfo, IModelElement
    {
        ...
        private void ElectricalAssetModelsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ElectricalTypeAssetsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
