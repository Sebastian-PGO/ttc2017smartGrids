...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfPaymentMetering
{
    ...
    public partial class SDPAccountingFunction : DeviceFunction, ISDPAccountingFunction, IModelElement
    {
        ...
        private void CreditRegistersCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ChargeRegistersCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
