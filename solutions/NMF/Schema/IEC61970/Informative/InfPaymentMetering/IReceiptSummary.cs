...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfPaymentMetering
{
    ...
    /// <summary>
    /// The public interface for ReceiptSummary
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(ReceiptSummary))]
    [XmlDefaultImplementationTypeAttribute(typeof(ReceiptSummary))]
    public interface IReceiptSummary : IModelElement, IElement
    {
        
        /// <summary>
        /// The tenderKind property
        /// </summary>
        Nullable<TenderKind> TenderKind
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TenderKindChanging;
        
        /// <summary>
        /// Gets fired when the TenderKind property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TenderKindChanged;
