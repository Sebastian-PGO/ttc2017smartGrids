...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfWork
{
    ...
    /// <summary>
    /// The default implementation of the ContractorItem class
    /// </summary>
    ...
    public partial class ContractorItem : IdentifiedObject, IContractorItem, IModelElement
    {
        ...
        {
            this._erpPayables = new ContractorItemErpPayablesCollection(this);
            this._erpPayables.CollectionChanging += this.ErpPayablesCollectionChanging;
            this._erpPayables.CollectionChanged += this.ErpPayablesCollectionChanged;
        }
        ...
        /// <summary>
        /// The ErpPayables property
        /// </summary>
        [DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Content)]
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("ContractorItems")]
        [ConstantAttribute()]
        public virtual IOrderedSetExpression<IErpPayable> ErpPayables
        {
            get
            {
                return this._erpPayables;
            }
        }
        ...
        public virtual IWorkCostDetail WorkCostDetail
        {
            ...
            set
            {
                if ((this._workCostDetail != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.ContractorItems.Remove(this);
                        old.Deleted -= this.OnResetWorkCostDetail;
                    }
                    if ((value != null))
                    {
                        value.ContractorItems.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ContractorItemReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfWork/Contracto" +
                            "rItem")));
                }
        ...
        private void ErpPayablesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("ErpPayables", e, _erpPayablesReference);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the ErpPayables property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        ...
        /// <summary>
        /// The collection class to to represent the children of the ContractorItem class
        /// </summary>
        public class ContractorItemReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ContractorItem _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ContractorItemReferencedElementsCollection(ContractorItem parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                get
                {
                    ...
                    count = (count + this._parent.ErpPayables.Count);
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.ErpPayables.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            public override void Clear()
            {
                ...
                this._parent.ErpPayables.Clear();
            ...
            public override bool Contains(IModelElement item)
            {
                ...
                if (this._parent.ErpPayables.Contains(item))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                IEnumerator<IModelElement> erpPayablesEnumerator = this._parent.ErpPayables.GetEnumerator();
                try
                {
                    for (
                    ; erpPayablesEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = erpPayablesEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    erpPayablesEnumerator.Dispose();
                }
                if ((this._parent.WorkCostDetail != null))
                {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Status).Concat(this._parent.ErpPayables).Concat(this._parent.WorkCostDetail).Concat(this._parent.WorkTask).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class CostProxy : ModelPropertyChange<IContractorItem, float>
        {
        ...
        /// </summary>
        private sealed class ActivityCodeProxy : ModelPropertyChange<IContractorItem, string>
        {
        ...
        /// </summary>
        private sealed class BidAmountProxy : ModelPropertyChange<IContractorItem, float>
        {
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IContractorItem, IStatus>
        {
        ...
        /// </summary>
        private sealed class WorkCostDetailProxy : ModelPropertyChange<IContractorItem, IWorkCostDetail>
        {
        ...
        /// </summary>
        private sealed class WorkTaskProxy : ModelPropertyChange<IContractorItem, IWorkTask>
        {
