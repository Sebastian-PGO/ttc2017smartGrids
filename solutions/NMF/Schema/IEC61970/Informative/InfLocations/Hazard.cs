...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfLocations
{
    ...
    /// <summary>
    /// The default implementation of the Hazard class
    /// </summary>
    ...
    public partial class Hazard : IdentifiedObject, IHazard, IModelElement
    {
        ...
        public Hazard()
        {
            this._locations = new HazardLocationsCollection(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new HazardReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfLocations/Haza" +
                            "rd")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the Hazard class
        /// </summary>
        public class HazardReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private Hazard _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public HazardReferencedElementsCollection(Hazard parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class CategoryProxy : ModelPropertyChange<IHazard, string>
        {
        ...
        /// </summary>
        private sealed class StatusProxy : ModelPropertyChange<IHazard, IStatus>
        {
