...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.InfLocations
{
    ...
    /// <summary>
    /// The default implementation of the Zone class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfLocations/Zone" +
        "")]
    [DebuggerDisplayAttribute("Zone {UUID}")]
    public partial class Zone : Location, IZone, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Kind property
        /// </summary>
        private Nullable<ZoneKind> _kind;
        ...
        public virtual Nullable<ZoneKind> Kind
        {
            get
            {
                return this._kind;
            ...
            set
            {
                if ((this._kind != value))
                {
                    Nullable<ZoneKind> old = this._kind;
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/InfLocations/Zone" +
                            "")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Zone.ClassInstance)).Resolve("kind")));
        }
        ...
        /// </summary>
        private sealed class KindProxy : ModelPropertyChange<IZone, Nullable<ZoneKind>>
        {
            ...
            public KindProxy(IZone modelElement) : 
            ...
            /// </summary>
            public override Nullable<ZoneKind> Value
            {
                get
                {
