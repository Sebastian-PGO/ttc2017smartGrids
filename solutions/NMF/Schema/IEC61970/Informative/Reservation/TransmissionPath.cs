...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Reservation
{
    ...
    public partial class TransmissionPath : Element, ITransmissionPath, IModelElement
    {
        ...
        private void OfferedOnCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void LocatedOnCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
