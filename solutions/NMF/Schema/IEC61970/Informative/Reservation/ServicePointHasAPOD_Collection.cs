...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Reservation
{
    ...
    public class ServicePointHasAPOD_Collection : ObservableOppositeOrderedSet<IServicePoint, ITransmissionPath>
    {
        
        public ServicePointHasAPOD_Collection(IServicePoint parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(ITransmissionPath item, IServicePoint parent)
        {
            if ((parent != null))
            {
                ...
                item.DeliveryPointFor = parent;
            }
            else
            {
                item.Deleted -= this.OnItemDeleted;
                if ((item.DeliveryPointFor == this.Parent))
                {
                    item.DeliveryPointFor = parent;
                }
            }
