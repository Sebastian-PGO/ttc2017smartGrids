...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Reservation
{
    ...
    public partial class ServicePoint : IdentifiedObject, IServicePoint, IModelElement
    {
        ...
        private void HasAPOR_CollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void HasAPOD_CollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
