...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.Reservation
{
    ...
    public partial class TiePoint : IdentifiedObject, ITiePoint, IModelElement
    {
        ...
        private void By_MeasurementsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void For_MeasurementsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
