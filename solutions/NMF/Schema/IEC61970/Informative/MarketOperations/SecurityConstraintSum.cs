...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    public partial class SecurityConstraintSum : MarketFactors, ISecurityConstraintSum, IModelElement
    {
        ...
        private void ContingencyConstraintLimitsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ConstraintTermsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
