...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    public partial class DefaultConstraintLimit : Curve, IDefaultConstraintLimit, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(DefaultConstraintLimit.ClassInstance)).Resolve("SecurityConstraintSum")));
        }
