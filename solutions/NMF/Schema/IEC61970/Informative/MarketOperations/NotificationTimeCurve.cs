...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    /// <summary>
    /// The default implementation of the NotificationTimeCurve class
    /// </summary>
    ...
    [DebuggerDisplayAttribute("NotificationTimeCurve {UUID}")]
    public partial class NotificationTimeCurve : Curve, INotificationTimeCurve, IModelElement
    {
        ...
        /// </summary>
        private NotificationTimeCurveGeneratingBidsCollection _generatingBids;
        
        private static IClass _classInstance;
        
        public NotificationTimeCurve()
        {
            this._generatingBids = new NotificationTimeCurveGeneratingBidsCollection(this);
        ...
        [XmlOppositeAttribute("NotificationTimeCurve")]
        [ConstantAttribute()]
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new NotificationTimeCurveReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NotificationTimeCurve.ClassInstance)).Resolve("GeneratingBids")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the NotificationTimeCurve class
        /// </summary>
        public class NotificationTimeCurveReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private NotificationTimeCurve _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public NotificationTimeCurveReferencedElementsCollection(NotificationTimeCurve parent)
            {
                this._parent = parent;
            }
