...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    /// <summary>
    /// The default implementation of the BidSet class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/MarketOperations/" +
        "BidSet")]
    [DebuggerDisplayAttribute("BidSet {UUID}")]
    public partial class BidSet : IdentifiedObject, IBidSet, IModelElement
    {
        ...
        /// </summary>
        private BidSetGeneratingBidsCollection _generatingBids;
        
        private static IClass _classInstance;
        
        public BidSet()
        {
            this._generatingBids = new BidSetGeneratingBidsCollection(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new BidSetReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(BidSet.ClassInstance)).Resolve("GeneratingBids")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the BidSet class
        /// </summary>
        public class BidSetReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private BidSet _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public BidSetReferencedElementsCollection(BidSet parent)
            {
                this._parent = parent;
            }
