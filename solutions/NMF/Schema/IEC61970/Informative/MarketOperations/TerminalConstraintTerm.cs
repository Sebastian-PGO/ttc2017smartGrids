...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    /// <summary>
    /// The default implementation of the TerminalConstraintTerm class
    /// </summary>
    ...
    public partial class TerminalConstraintTerm : ConstraintTerm, ITerminalConstraintTerm, IModelElement
    {
        ...
        [XmlOppositeAttribute("TerminalConstraints")]
        public virtual ITerminal Terminal
        {
            ...
            set
            {
                if ((this._terminal != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.TerminalConstraints.Remove(this);
                        old.Deleted -= this.OnResetTerminal;
                    }
                    if ((value != null))
                    {
                        value.TerminalConstraints.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new TerminalConstraintTermReferencedElementsCollection(this));
            }
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the TerminalConstraintTerm class
        /// </summary>
        public class TerminalConstraintTermReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private TerminalConstraintTerm _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public TerminalConstraintTermReferencedElementsCollection(TerminalConstraintTerm parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class TerminalProxy : ModelPropertyChange<ITerminalConstraintTerm, ITerminal>
        {
