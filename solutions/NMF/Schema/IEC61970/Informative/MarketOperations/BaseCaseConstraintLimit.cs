...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    /// <summary>
    /// The default implementation of the BaseCaseConstraintLimit class
    /// </summary>
    ...
    public partial class BaseCaseConstraintLimit : Curve, IBaseCaseConstraintLimit, IModelElement
    {
        ...
        [XmlOppositeAttribute("BaseCaseConstraintLimit")]
        public virtual ISecurityConstraintSum SecurityConstraintSum
        {
            ...
            set
            {
                if ((this._securityConstraintSum != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.BaseCaseConstraintLimit = null;
                        old.Deleted -= this.OnResetSecurityConstraintSum;
                    }
                    if ((value != null))
                    {
                        value.BaseCaseConstraintLimit = this;
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new BaseCaseConstraintLimitReferencedElementsCollection(this));
            }
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the BaseCaseConstraintLimit class
        /// </summary>
        public class BaseCaseConstraintLimitReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private BaseCaseConstraintLimit _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public BaseCaseConstraintLimitReferencedElementsCollection(BaseCaseConstraintLimit parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class SecurityConstraintSumProxy : ModelPropertyChange<IBaseCaseConstraintLimit, ISecurityConstraintSum>
        {
