...
namespace TTC2017.SmartGrids.CIM.IEC61970.Informative.MarketOperations
{
    ...
    /// <summary>
    /// The default implementation of the NodeConstraintTerm class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Informative/MarketOperations/" +
        "NodeConstraintTerm")]
    [DebuggerDisplayAttribute("NodeConstraintTerm {UUID}")]
    public partial class NodeConstraintTerm : ConstraintTerm, INodeConstraintTerm, IModelElement
    {
        ...
        [XmlOppositeAttribute("NodeConstraintTerms")]
        public virtual IConnectivityNode ConnectivityNode
        {
            ...
            set
            {
                if ((this._connectivityNode != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.NodeConstraintTerms.Remove(this);
                        old.Deleted -= this.OnResetConnectivityNode;
                    }
                    if ((value != null))
                    {
                        value.NodeConstraintTerms.Add(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new NodeConstraintTermReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NodeConstraintTerm.ClassInstance)).Resolve("ConnectivityNode")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the NodeConstraintTerm class
        /// </summary>
        public class NodeConstraintTermReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private NodeConstraintTerm _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public NodeConstraintTermReferencedElementsCollection(NodeConstraintTerm parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ConnectivityNode).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class ConnectivityNodeProxy : ModelPropertyChange<INodeConstraintTerm, IConnectivityNode>
        {
            ...
            public ConnectivityNodeProxy(INodeConstraintTerm modelElement) : 
