...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public partial class ConnectivityNode : IdentifiedObject, IConnectivityNode, IModelElement
    {
        ...
        private void LossPenaltyFactorsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void NodeConstraintTermsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
