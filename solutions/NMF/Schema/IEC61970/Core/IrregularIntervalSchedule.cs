...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The default implementation of the IrregularIntervalSchedule class
    /// </summary>
    ...
    public partial class IrregularIntervalSchedule : BasicIntervalSchedule, IIrregularIntervalSchedule, IModelElement
    {
        ...
        /// </summary>
        private IrregularIntervalScheduleTimePointsCollection _timePoints;
        
        private static IClass _classInstance;
        
        public IrregularIntervalSchedule()
        {
            this._timePoints = new IrregularIntervalScheduleTimePointsCollection(this);
        ...
        [ConstantAttribute()]
        public virtual IOrderedSetExpression<IIrregularTimePoint> TimePoints
        {
            get
            {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new IrregularIntervalScheduleReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Core/IrregularIntervalSchedul" +
                            "e")));
                }
        ...
        private void TimePointsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <summary>
        /// The collection class to to represent the children of the IrregularIntervalSchedule class
        /// </summary>
        public class IrregularIntervalScheduleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private IrregularIntervalSchedule _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public IrregularIntervalScheduleReferencedElementsCollection(IrregularIntervalSchedule parent)
            {
                this._parent = parent;
            }
            ...
            {
                IIrregularTimePoint timePointsCasted = item.As<IIrregularTimePoint>();
            ...
            {
                IIrregularTimePoint irregularTimePointItem = item.As<IIrregularTimePoint>();
                if (((irregularTimePointItem != null) 
                            && this._parent.TimePoints.Remove(irregularTimePointItem)))
                {
                    return true;
                }
                return false;
