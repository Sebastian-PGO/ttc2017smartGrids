...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The public interface for RegularTimePoint
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(RegularTimePoint))]
    [XmlDefaultImplementationTypeAttribute(typeof(RegularTimePoint))]
    public interface IRegularTimePoint : IModelElement, IElement
    {
        ...
        /// </summary>
        IRegularIntervalSchedule IntervalSchedule
        {
            get;
            set;
        }
