...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public partial class BaseVoltage : IdentifiedObject, IBaseVoltage, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void VoltageLevelCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ConductingEquipmentCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
