...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The public interface for IdentifiedObject
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(IdentifiedObject))]
    [XmlDefaultImplementationTypeAttribute(typeof(IdentifiedObject))]
    public interface IIdentifiedObject : IModelElement, IElement
    {
        ...
        /// </summary>
        IModelingAuthoritySet ModelingAuthoritySet
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> PathNameChanging;
        
        /// <summary>
        /// Gets fired when the PathName property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> PathNameChanged;
        
        /// <summary>
        /// Gets fired before the LocalName property changes its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> LocalNameChanging;
        
        /// <summary>
        /// Gets fired when the LocalName property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> LocalNameChanged;
        
        /// <summary>
        /// Gets fired before the AliasName property changes its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> AliasNameChanging;
        
        /// <summary>
        /// Gets fired when the AliasName property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> AliasNameChanged;
        
        /// <summary>
        /// Gets fired before the ModelingAuthoritySet property changes its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ModelingAuthoritySetChanging;
        
        /// <summary>
        /// Gets fired when the ModelingAuthoritySet property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ModelingAuthoritySetChanged;
    }
}
