...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The default implementation of the PSRType class
    /// </summary>
    ...
    public partial class PSRType : IdentifiedObject, IPSRType, IModelElement
    {
        ...
        /// </summary>
        private PSRTypePowerSystemResourcesCollection _powerSystemResources;
        
        private static IClass _classInstance;
        
        public PSRType()
        {
            this._powerSystemResources = new PSRTypePowerSystemResourcesCollection(this);
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new PSRTypeReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Core/PSRType")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the PSRType class
        /// </summary>
        public class PSRTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private PSRType _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public PSRTypeReferencedElementsCollection(PSRType parent)
            {
                this._parent = parent;
            }
