...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public partial class ReportingGroup : IdentifiedObject, IReportingGroup, IModelElement
    {
        ...
        private void PowerSystemResourceCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void BusNameMarkerCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
