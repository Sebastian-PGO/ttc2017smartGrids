...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The public interface for PsrList
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(PsrList))]
    [XmlDefaultImplementationTypeAttribute(typeof(PsrList))]
    public interface IPsrList : IModelElement, IIdentifiedObject
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TypePSRListChanging;
        
        /// <summary>
        /// Gets fired when the TypePSRList property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> TypePSRListChanged;
    }
}
