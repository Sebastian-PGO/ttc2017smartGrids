...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The public interface for GeographicalRegion
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(GeographicalRegion))]
    [XmlDefaultImplementationTypeAttribute(typeof(GeographicalRegion))]
    public interface IGeographicalRegion : IModelElement, IIdentifiedObject
    {
        
        /// <summary>
        /// The Regions property
        /// </summary>
        IOrderedSetExpression<ISubGeographicalRegion> Regions
        {
            get;
        }
    }
