...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class UnitControlsCollection : ObservableOppositeOrderedSet<IUnit, IControl>
    {
        
        public UnitControlsCollection(IUnit parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IControl item, IUnit parent)
        {
            if ((parent != null))
            {
