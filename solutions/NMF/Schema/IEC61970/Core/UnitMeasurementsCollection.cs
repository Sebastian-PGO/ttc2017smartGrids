...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class UnitMeasurementsCollection : ObservableOppositeOrderedSet<IUnit, IMeasurement>
    {
        
        public UnitMeasurementsCollection(IUnit parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IMeasurement item, IUnit parent)
        {
            if ((parent != null))
            {
