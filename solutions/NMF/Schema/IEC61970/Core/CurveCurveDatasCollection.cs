...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class CurveCurveDatasCollection : ObservableOppositeOrderedSet<ICurve, ICurveData>
    {
        
        public CurveCurveDatasCollection(ICurve parent) : 
                base(parent)
        {
        }
        ...
        {
            this.Remove(((ICurveData)(sender)));
        }
        
        protected override void SetOpposite(ICurveData item, ICurve parent)
        {
            if ((parent != null))
            {
