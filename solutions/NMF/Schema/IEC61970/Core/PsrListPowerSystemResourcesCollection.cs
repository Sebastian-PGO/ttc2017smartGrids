...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class PsrListPowerSystemResourcesCollection : ObservableOppositeOrderedSet<IPsrList, IPowerSystemResource>
    {
        
        public PsrListPowerSystemResourcesCollection(IPsrList parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IPowerSystemResource item, IPsrList parent)
        {
            if ((parent != null))
            {
                item.Deleted += this.OnItemDeleted;
                item.PsrLists.Add(parent);
            }
            else
            {
                item.Deleted -= this.OnItemDeleted;
                item.PsrLists.Remove(this.Parent);
            }
        }
    }
}
