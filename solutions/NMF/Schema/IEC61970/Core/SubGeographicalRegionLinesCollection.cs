...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class SubGeographicalRegionLinesCollection : ObservableOppositeOrderedSet<ISubGeographicalRegion, ILine>
    {
        
        public SubGeographicalRegionLinesCollection(ISubGeographicalRegion parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(ILine item, ISubGeographicalRegion parent)
        {
            if ((parent != null))
            {
