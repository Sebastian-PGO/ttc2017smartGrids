...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    public class PSRTypePowerSystemResourcesCollection : ObservableOppositeOrderedSet<IPSRType, IPowerSystemResource>
    {
        
        public PSRTypePowerSystemResourcesCollection(IPSRType parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IPowerSystemResource item, IPSRType parent)
        {
            if ((parent != null))
            {
