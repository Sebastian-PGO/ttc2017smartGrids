...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The public interface for PSRType
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(PSRType))]
    [XmlDefaultImplementationTypeAttribute(typeof(PSRType))]
    public interface IPSRType : IModelElement, IIdentifiedObject
    {
