...
namespace TTC2017.SmartGrids.CIM.IEC61970.Core
{
    ...
    /// <summary>
    /// The default implementation of the ReportingSuperGroup class
    /// </summary>
    ...
    public partial class ReportingSuperGroup : IdentifiedObject, IReportingSuperGroup, IModelElement
    {
        ...
        /// </summary>
        private ReportingSuperGroupReportingGroupCollection _reportingGroup;
        
        private static IClass _classInstance;
        
        public ReportingSuperGroup()
        {
            this._reportingGroup = new ReportingSuperGroupReportingGroupCollection(this);
        ...
        [XmlOppositeAttribute("ReportingSuperGroup")]
        [ConstantAttribute()]
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ReportingSuperGroupReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://iec.ch/TC57/2009/CIM-schema-cim14#//IEC61970/Core/ReportingSuperGroup")));
                }
        ...
        private void ReportingGroupCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <summary>
        /// The collection class to to represent the children of the ReportingSuperGroup class
        /// </summary>
        public class ReportingSuperGroupReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ReportingSuperGroup _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ReportingSuperGroupReferencedElementsCollection(ReportingSuperGroup parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ReportingGroup).GetEnumerator();
            }
        }
    }
}
