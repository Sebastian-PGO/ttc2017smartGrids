...
namespace TTC2017.SmartGrids.CIM.IEC61970.SCADA
{
    ...
    public partial class RemoteUnit : PowerSystemResource, IRemoteUnit, IModelElement
    {
        ...
        private void RemotePointsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CommunicationLinksCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
