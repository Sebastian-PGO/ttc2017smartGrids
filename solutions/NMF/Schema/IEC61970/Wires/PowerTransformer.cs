...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    public partial class PowerTransformer : Equipment, IPowerTransformer, IModelElement
    {
        ...
        private void FlowgatesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void TransformerWindingsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
