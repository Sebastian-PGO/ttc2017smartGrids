...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    /// <summary>
    /// The public interface for Breaker
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Breaker))]
    [XmlDefaultImplementationTypeAttribute(typeof(Breaker))]
    public interface IBreaker : IModelElement, IProtectedSwitch
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> InTransitTimeChanging;
        
        /// <summary>
        /// Gets fired when the InTransitTime property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> InTransitTimeChanged;
    }
}
