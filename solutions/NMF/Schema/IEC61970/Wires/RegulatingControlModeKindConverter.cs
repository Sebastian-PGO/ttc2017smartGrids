...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    public class RegulatingControlModeKindConverter : System.ComponentModel.TypeConverter
    {
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            if ((value == null))
            {
                return default(RegulatingControlModeKind);
            }
            ...
            if ((valueString == "activePower"))
            {
                return RegulatingControlModeKind.ActivePower;
            }
            if ((valueString == "currentFlow"))
            {
