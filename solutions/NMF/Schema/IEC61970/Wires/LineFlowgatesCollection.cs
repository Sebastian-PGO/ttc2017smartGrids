...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    public class LineFlowgatesCollection : ObservableOppositeOrderedSet<ILine, IFlowgate>
    {
        
        public LineFlowgatesCollection(ILine parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IFlowgate item, ILine parent)
        {
            if ((parent != null))
            {
                item.Deleted += this.OnItemDeleted;
                item.Lines.Add(parent);
            }
            else
            {
                item.Deleted -= this.OnItemDeleted;
                item.Lines.Remove(this.Parent);
            }
        }
    }
}
