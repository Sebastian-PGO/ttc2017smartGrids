...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    /// <summary>
    /// The public interface for RegulatingCondEq
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(RegulatingCondEq))]
    [XmlDefaultImplementationTypeAttribute(typeof(RegulatingCondEq))]
    public interface IRegulatingCondEq : IModelElement, IConductingEquipment
    {
        
        /// <summary>
        /// The Controls property
        /// </summary>
        IOrderedSetExpression<IControl> Controls
        {
            get;
        }
