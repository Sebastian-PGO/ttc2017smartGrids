...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    public partial class SynchronousMachine : RegulatingCondEq, ISynchronousMachine, IModelElement
    {
        ...
        private void ReactiveCapabilityCurvesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void PrimeMoversCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
