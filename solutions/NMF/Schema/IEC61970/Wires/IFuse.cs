...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    /// <summary>
    /// The public interface for Fuse
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Fuse))]
    [XmlDefaultImplementationTypeAttribute(typeof(Fuse))]
    public interface IFuse : IModelElement, ISwitch
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> RatingCurrentChanging;
        
        /// <summary>
        /// Gets fired when the RatingCurrent property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> RatingCurrentChanged;
    }
}
