...
namespace TTC2017.SmartGrids.CIM.IEC61970.Wires
{
    ...
    public partial class Switch : ConductingEquipment, ISwitch, IModelElement
    {
        ...
        private void LoadMgmtFunctionsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ConnectDisconnectFunctionsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void SwitchSchedulesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
