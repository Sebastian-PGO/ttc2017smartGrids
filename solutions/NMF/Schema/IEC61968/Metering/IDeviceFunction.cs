...
namespace TTC2017.SmartGrids.CIM.IEC61968.Metering
{
    ...
    /// <summary>
    /// The public interface for DeviceFunction
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(DeviceFunction))]
    [XmlDefaultImplementationTypeAttribute(typeof(DeviceFunction))]
    public interface IDeviceFunction : IModelElement, IAssetFunction
    {
        ...
        /// </summary>
        IComEquipmentInfo ComEquipmentAsset
        {
            get;
            set;
        }
        ...
        /// </summary>
        IOrderedSetExpression<IRegister> Registers
        {
            get;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ComEquipmentAssetChanging;
        
        /// <summary>
        /// Gets fired when the ComEquipmentAsset property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ComEquipmentAssetChanged;
