...
namespace TTC2017.SmartGrids.CIM.IEC61968.WiresExt
{
    ...
    public partial class DistributionTransformerWinding : ConductingEquipment, IDistributionTransformerWinding, IModelElement
    {
        ...
        private void FromWindingInsulationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ToWindingInsulationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
