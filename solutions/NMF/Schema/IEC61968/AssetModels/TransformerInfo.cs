...
namespace TTC2017.SmartGrids.CIM.IEC61968.AssetModels
{
    ...
    public partial class TransformerInfo : IdentifiedObject, ITransformerInfo, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void WindingInfosCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void TransformerAssetModelsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void TransformerAssetsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
