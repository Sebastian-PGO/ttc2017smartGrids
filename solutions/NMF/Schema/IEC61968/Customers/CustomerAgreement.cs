...
namespace TTC2017.SmartGrids.CIM.IEC61968.Customers
{
    ...
    public partial class CustomerAgreement : Agreement, ICustomerAgreement, IModelElement
    {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ServiceLocationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AuxiliaryAgreementsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void EquipmentsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
