...
namespace TTC2017.SmartGrids.CIM.IEC61968.Common
{
    ...
    public partial class Organisation : IdentifiedObject, IOrganisation, IModelElement
    {
        ...
        private void MarketRolesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void BusinessRolesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
