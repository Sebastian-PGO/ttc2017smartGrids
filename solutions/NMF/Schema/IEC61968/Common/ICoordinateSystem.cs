...
namespace TTC2017.SmartGrids.CIM.IEC61968.Common
{
    ...
    /// <summary>
    /// The public interface for CoordinateSystem
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(CoordinateSystem))]
    [XmlDefaultImplementationTypeAttribute(typeof(CoordinateSystem))]
    public interface ICoordinateSystem : IModelElement, IElement
    {
        ...
        /// </summary>
        IOrderedSetExpression<IPositionPoint> PositionPoints
        {
            get;
        }
