...
namespace TTC2017.SmartGrids.CIM.IEC61968.PaymentMetering
{
    ...
    public partial class PointOfSale : IdentifiedObject, IPointOfSale, IModelElement
    {
        ...
        private void TokensCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CashierShiftsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
