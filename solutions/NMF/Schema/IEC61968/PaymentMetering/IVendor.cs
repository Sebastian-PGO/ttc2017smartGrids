...
namespace TTC2017.SmartGrids.CIM.IEC61968.PaymentMetering
{
    ...
    /// <summary>
    /// The public interface for Vendor
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Vendor))]
    [XmlDefaultImplementationTypeAttribute(typeof(Vendor))]
    public interface IVendor : IModelElement, IIdentifiedObject
    {
        
        /// <summary>
        /// The PointOfSales property
        /// </summary>
        IOrderedSetExpression<IPointOfSale> PointOfSales
        {
            get;
        }
        ...
        /// </summary>
        IOrderedSetExpression<ICashier> Cashiers
        {
            get;
        }
