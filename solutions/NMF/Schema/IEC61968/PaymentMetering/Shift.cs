...
namespace TTC2017.SmartGrids.CIM.IEC61968.PaymentMetering
{
    ...
    public partial class Shift : IdentifiedObject, IShift, IModelElement
    {
        ...
        private void TransactionSummariesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ReceiptSummariesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
