...
namespace TTC2017.SmartGrids.CIM.IEC61968.PaymentMetering
{
    ...
    /// <summary>
    /// The public interface for TimeTariffInterval
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(TimeTariffInterval))]
    [XmlDefaultImplementationTypeAttribute(typeof(TimeTariffInterval))]
    public interface ITimeTariffInterval : IModelElement, IElement
    {
