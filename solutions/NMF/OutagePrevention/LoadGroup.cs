...
namespace TTC2017.SmartGrids.OutagePreventionJointarget
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/VoltagePhaseMeasurement" +
        "s#//LoadGroup")]
    public partial class LoadGroup : ModelElement, ILoadGroup, IModelElement
    {
        ...
        public ISubLoadArea SubLoadArea
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutagePreventionJointarget.LoadGroup.ClassInstance)).Resolve("SubLoadArea")));
        }
        ...
        public class LoadGroupReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.SubLoadArea).GetEnumerator();
            }
        }
