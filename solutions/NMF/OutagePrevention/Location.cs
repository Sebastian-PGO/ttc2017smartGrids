...
namespace TTC2017.SmartGrids.OutagePreventionJointarget
{
    ...
    public partial class Location : ModelElement, ILocation, IModelElement
    {
        ...
        /// </summary>
        private ObservableAssociationOrderedSet<IPowerSystemResource> _powerSystemResources;
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public IOrderedSetExpression<IPowerSystemResource> PowerSystemResources
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutagePreventionJointarget.Location.ClassInstance)).Resolve("Position")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2017.SmartGrids.OutagePreventionJointarget.Location.ClassInstance)).Resolve("PowerSystemResources")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void PowerSystemResourcesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        public class LocationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Position).Concat(this._parent.PowerSystemResources).GetEnumerator();
            }
        }
