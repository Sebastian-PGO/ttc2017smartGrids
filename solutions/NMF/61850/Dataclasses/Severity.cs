...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class Severity : ModelElement, ISeverity, IModelElement
    {
        ...
        public virtual Nullable<SeverityKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<SeverityKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(Severity.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<ISeverity, Nullable<SeverityKind>>
        {
            ...
            /// </summary>
            public override Nullable<SeverityKind> Value
            {
                get
                {
