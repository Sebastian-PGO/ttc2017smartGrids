...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class CurveChar : ModelElement, ICurveChar, IModelElement
    {
        ...
        public virtual Nullable<CurveCharKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<CurveCharKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(CurveChar.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<ICurveChar, Nullable<CurveCharKind>>
        {
            ...
            public ValProxy(ICurveChar modelElement) : 
            ...
            /// </summary>
            public override Nullable<CurveCharKind> Value
            {
                get
                {
