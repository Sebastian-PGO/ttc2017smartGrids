...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class DPC : ModelElement, IDPC, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new DPCReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("ctlVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("stVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("q")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("t")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("subVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPC.ClassInstance)).Resolve("pulseConfig")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the DPC class
        /// </summary>
        public class DPCReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public DPCReferencedElementsCollection(DPC parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.StVal).Concat(this._parent.Q).Concat(this._parent.T).Concat(this._parent.SubVal).Concat(this._parent.PulseConfig).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class CtlValProxy : ModelPropertyChange<IDPC, Nullable<bool>>
        {
        ...
        /// </summary>
        private sealed class StValProxy : ModelPropertyChange<IDPC, IDPStatus>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StValProxy(IDPC modelElement) : 
        ...
        /// </summary>
        private sealed class QProxy : ModelPropertyChange<IDPC, IQuality>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public QProxy(IDPC modelElement) : 
                    base(modelElement, "q")
            {
            }
        ...
        /// </summary>
        private sealed class TProxy : ModelPropertyChange<IDPC, ITimeStamp>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public TProxy(IDPC modelElement) : 
                    base(modelElement, "t")
            {
            }
        ...
        /// </summary>
        private sealed class SubValProxy : ModelPropertyChange<IDPC, IDPStatus>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public SubValProxy(IDPC modelElement) : 
        ...
        /// </summary>
        private sealed class PulseConfigProxy : ModelPropertyChange<IDPC, IPulseConfig>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public PulseConfigProxy(IDPC modelElement) : 
