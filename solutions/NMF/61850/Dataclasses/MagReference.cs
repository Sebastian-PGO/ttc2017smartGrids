...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the MagReference class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/MagReference")]
    public partial class MagReference : ModelElement, IMagReference, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<MagReferenceKind> _val;
        ...
        public virtual Nullable<MagReferenceKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<MagReferenceKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(MagReference.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((MagReferenceKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IMagReference, Nullable<MagReferenceKind>>
        {
            ...
            public ValProxy(IMagReference modelElement) : 
            ...
            /// </summary>
            public override Nullable<MagReferenceKind> Value
            {
                get
                {
