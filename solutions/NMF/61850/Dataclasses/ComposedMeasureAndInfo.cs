...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the ComposedMeasureAndInfo class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/ComposedMeasureAndInfo")]
    public partial class ComposedMeasureAndInfo : ModelElement, IComposedMeasureAndInfo, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(ComposedMeasureAndInfo.ClassInstance)).Resolve("d")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(ComposedMeasureAndInfo.ClassInstance)).Resolve("dU")));
        }
        ...
        /// </summary>
        private sealed class DProxy : ModelPropertyChange<IComposedMeasureAndInfo, string>
        {
            ...
            public DProxy(IComposedMeasureAndInfo modelElement) : 
                    base(modelElement, "d")
            {
            }
        ...
        /// </summary>
        private sealed class DUProxy : ModelPropertyChange<IComposedMeasureAndInfo, string>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public DUProxy(IComposedMeasureAndInfo modelElement) : 
