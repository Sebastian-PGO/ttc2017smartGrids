...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the SboClasses class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/SboClasses")]
    public partial class SboClasses : ModelElement, ISboClasses, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<SboClassesKind> _val;
        ...
        public virtual Nullable<SboClassesKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<SboClassesKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(SboClasses.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<ISboClasses, Nullable<SboClassesKind>>
        {
            ...
            public ValProxy(ISboClasses modelElement) : 
            ...
            /// </summary>
            public override Nullable<SboClassesKind> Value
            {
                get
                {
