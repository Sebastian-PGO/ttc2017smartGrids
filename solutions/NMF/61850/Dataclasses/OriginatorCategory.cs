...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the OriginatorCategory class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/OriginatorCategory")]
    public partial class OriginatorCategory : ModelElement, IOriginatorCategory, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<OriginatorCategoryKind> _val;
        ...
        public virtual Nullable<OriginatorCategoryKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<OriginatorCategoryKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(OriginatorCategory.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((OriginatorCategoryKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IOriginatorCategory, Nullable<OriginatorCategoryKind>>
        {
            ...
            public ValProxy(IOriginatorCategory modelElement) : 
            ...
            /// </summary>
            public override Nullable<OriginatorCategoryKind> Value
            {
                get
                {
