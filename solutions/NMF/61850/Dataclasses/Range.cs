...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class Range : ModelElement, IRange, IModelElement
    {
        ...
        public virtual Nullable<RangeKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<RangeKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(Range.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IRange, Nullable<RangeKind>>
        {
            ...
            public ValProxy(IRange modelElement) : 
            ...
            /// </summary>
            public override Nullable<RangeKind> Value
            {
                get
                {
