...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the DirectionPhase class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/DirectionPhase")]
    public partial class DirectionPhase : ModelElement, IDirectionPhase, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<DirectionPhaseKind> _val;
        ...
        public virtual Nullable<DirectionPhaseKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<DirectionPhaseKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(DirectionPhase.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((DirectionPhaseKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IDirectionPhase, Nullable<DirectionPhaseKind>>
        {
            ...
            public ValProxy(IDirectionPhase modelElement) : 
            ...
            /// </summary>
            public override Nullable<DirectionPhaseKind> Value
            {
                get
                {
