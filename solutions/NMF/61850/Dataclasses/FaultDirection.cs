...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the FaultDirection class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/FaultDirection")]
    public partial class FaultDirection : ModelElement, IFaultDirection, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<FaultDirectionKind> _val;
        ...
        public virtual Nullable<FaultDirectionKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<FaultDirectionKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(FaultDirection.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((FaultDirectionKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IFaultDirection, Nullable<FaultDirectionKind>>
        {
            ...
            public ValProxy(IFaultDirection modelElement) : 
            ...
            /// </summary>
            public override Nullable<FaultDirectionKind> Value
            {
                get
                {
