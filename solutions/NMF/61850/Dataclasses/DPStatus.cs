...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class DPStatus : ModelElement, IDPStatus, IModelElement
    {
        ...
        public virtual Nullable<DPStatusKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<DPStatusKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(DPStatus.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IDPStatus, Nullable<DPStatusKind>>
        {
            ...
            public ValProxy(IDPStatus modelElement) : 
            ...
            /// </summary>
            public override Nullable<DPStatusKind> Value
            {
                get
                {
