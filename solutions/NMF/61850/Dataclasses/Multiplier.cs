...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the Multiplier class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/Multiplier")]
    public partial class Multiplier : ModelElement, IMultiplier, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<MultiplierKind> _val;
        ...
        public virtual Nullable<MultiplierKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<MultiplierKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(Multiplier.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IMultiplier, Nullable<MultiplierKind>>
        {
            ...
            /// </summary>
            public override Nullable<MultiplierKind> Value
            {
                get
                {
