...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the ControlOutput class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/ControlOutput")]
    public partial class ControlOutput : ModelElement, IControlOutput, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<ControlOutputKind> _val;
        ...
        public virtual Nullable<ControlOutputKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<ControlOutputKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(ControlOutput.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((ControlOutputKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IControlOutput, Nullable<ControlOutputKind>>
        {
            ...
            /// </summary>
            public override Nullable<ControlOutputKind> Value
            {
                get
                {
