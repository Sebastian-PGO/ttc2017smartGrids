...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class BSControl : ModelElement, IBSControl, IModelElement
    {
        ...
        public virtual Nullable<BSControlKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<BSControlKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(BSControl.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IBSControl, Nullable<BSControlKind>>
        {
            ...
            public ValProxy(IBSControl modelElement) : 
            ...
            /// </summary>
            public override Nullable<BSControlKind> Value
            {
                get
                {
