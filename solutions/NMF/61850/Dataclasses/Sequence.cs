...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class Sequence : ModelElement, ISequence, IModelElement
    {
        ...
        public virtual Nullable<SequenceKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<SequenceKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(Sequence.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<ISequence, Nullable<SequenceKind>>
        {
            ...
            public ValProxy(ISequence modelElement) : 
            ...
            /// </summary>
            public override Nullable<SequenceKind> Value
            {
                get
                {
