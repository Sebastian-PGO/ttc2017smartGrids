...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    /// <summary>
    /// The default implementation of the PhaseReference class
    /// </summary>
    [XmlNamespaceAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/dataclasses")]
    [XmlNamespacePrefixAttribute("data")]
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//Da" +
        "taclasses/PhaseReference")]
    public partial class PhaseReference : ModelElement, IPhaseReference, IModelElement
    {
        
        /// <summary>
        /// The backing field for the Val property
        /// </summary>
        private Nullable<PhaseReferenceKind> _val;
        ...
        public virtual Nullable<PhaseReferenceKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<PhaseReferenceKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(PhaseReference.ClassInstance)).Resolve("val")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "VAL"))
            {
                this.Val = ((PhaseReferenceKind)(value));
                return;
            }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<IPhaseReference, Nullable<PhaseReferenceKind>>
        {
            ...
            /// </summary>
            public override Nullable<PhaseReferenceKind> Value
            {
                get
                {
