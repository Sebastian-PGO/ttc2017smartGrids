...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class CtlModels : ModelElement, ICtlModels, IModelElement
    {
        ...
        public virtual Nullable<CtlModelsKind> Val
        {
            get
            {
                return this._val;
            ...
            set
            {
                if ((this._val != value))
                {
                    Nullable<CtlModelsKind> old = this._val;
        ...
        {
            return ((ITypedElement)(((ModelElement)(CtlModels.ClassInstance)).Resolve("val")));
        }
        ...
        /// </summary>
        private sealed class ValProxy : ModelPropertyChange<ICtlModels, Nullable<CtlModelsKind>>
        {
            ...
            public ValProxy(ICtlModels modelElement) : 
            ...
            /// </summary>
            public override Nullable<CtlModelsKind> Value
            {
                get
                {
