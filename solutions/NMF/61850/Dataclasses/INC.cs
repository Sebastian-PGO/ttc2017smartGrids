...
namespace TTC2017.SmartGrids.SubstationStandard.Dataclasses
{
    ...
    public partial class INC : ModelElement, IINC, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new INCReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("ctlVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("stVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("subVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("minVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("maxVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("stepSize")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("q")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(INC.ClassInstance)).Resolve("t")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the INC class
        /// </summary>
        public class INCReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public INCReferencedElementsCollection(INC parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Q).Concat(this._parent.T).GetEnumerator();
            }
        }
        ...
        /// </summary>
        private sealed class CtlValProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            public CtlValProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class StValProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StValProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class SubValProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public SubValProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class MinValProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public MinValProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class MaxValProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public MaxValProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class StepSizeProxy : ModelPropertyChange<IINC, Nullable<int>>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StepSizeProxy(IINC modelElement) : 
        ...
        /// </summary>
        private sealed class QProxy : ModelPropertyChange<IINC, IQuality>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public QProxy(IINC modelElement) : 
                    base(modelElement, "q")
            {
            }
        ...
        /// </summary>
        private sealed class TProxy : ModelPropertyChange<IINC, ITimeStamp>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public TProxy(IINC modelElement) : 
                    base(modelElement, "t")
            {
            }
