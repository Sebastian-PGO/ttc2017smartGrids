...
namespace TTC2017.SmartGrids.SubstationStandard.Enumerations
{
    ...
    public class RangeKindConverter : System.ComponentModel.TypeConverter
    {
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            if ((valueString == "high"))
            {
                return RangeKind.High;
            }
            if ((valueString == "low"))
            {
                return RangeKind.Low;
            }
            if ((valueString == "highHigh"))
            {
                return RangeKind.HighHigh;
            }
            if ((valueString == "lowLow"))
            {
                return RangeKind.LowLow;
            }
            return default(RangeKind);
        }
