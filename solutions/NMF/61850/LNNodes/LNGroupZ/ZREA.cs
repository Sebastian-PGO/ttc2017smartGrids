...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupZ
{
    ...
    /// <summary>
    /// The default implementation of the ZREA class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupZ/ZREA")]
    public partial class ZREA : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupZ.GroupZ, IZREA, IModelElement
    {
        ...
        private static Lazy<ITypedElement> _reactorControlReference = new Lazy<ITypedElement>(RetrieveReactorControlReference);
        
        /// <summary>
        /// The backing field for the ReactorControl property
        /// </summary>
        private IARCO _reactorControl;
        ...
        /// </summary>
        [XmlAttributeAttribute(true)]
        public virtual IARCO ReactorControl
        {
            get
            {
                return this._reactorControl;
            }
            set
            {
                if ((this._reactorControl != value))
                {
                    IARCO old = this._reactorControl;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnReactorControlChanging(e);
                    this.OnPropertyChanging("ReactorControl", e, _reactorControlReference);
                    this._reactorControl = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetReactorControl;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetReactorControl;
                    }
                    this.OnReactorControlChanged(e);
                    this.OnPropertyChanged("ReactorControl", e, _reactorControlReference);
                }
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ZREAReferencedElementsCollection(this));
            }
        }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ReactorControlChanging;
        
        /// <summary>
        /// Gets fired when the ReactorControl property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ReactorControlChanged;
        
        private static ITypedElement RetrieveOpTmhReference()
        {
            return ((ITypedElement)(((ModelElement)(ZREA.ClassInstance)).Resolve("OpTmh")));
        }
        ...
        private static ITypedElement RetrieveReactorControlReference()
        {
            return ((ITypedElement)(((ModelElement)(ZREA.ClassInstance)).Resolve("ReactorControl")));
        }
        
        /// <summary>
        /// Raises the ReactorControlChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnReactorControlChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ReactorControlChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ReactorControlChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnReactorControlChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ReactorControlChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the ReactorControl property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetReactorControl(object sender, System.EventArgs eventArgs)
        {
            this.ReactorControl = null;
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ZREA class
        /// </summary>
        public class ZREAReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ZREA _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ZREAReferencedElementsCollection(ZREA parent)
            {
                this._parent = parent;
            }
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.ReactorControlChanged += this.PropagateValueChanges;
            }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if ((this._parent.ReactorControl == item))
                {
                    this._parent.ReactorControl = null;
                    return true;
                }
        ...
        /// </summary>
        private sealed class OpTmhProxy : ModelPropertyChange<IZREA, IINS>
        {
            ...
            public OpTmhProxy(IZREA modelElement) : 
        ...
        /// </summary>
        private sealed class ReactorControlProxy : ModelPropertyChange<IZREA, IARCO>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ReactorControlProxy(IZREA modelElement) : 
                    base(modelElement, "ReactorControl")
            {
            }
            ...
            public override IARCO Value
            {
                get
                {
                    return this.ModelElement.ReactorControl;
                }
                set
                {
                    this.ModelElement.ReactorControl = value;
                }
            }
        }
    }
