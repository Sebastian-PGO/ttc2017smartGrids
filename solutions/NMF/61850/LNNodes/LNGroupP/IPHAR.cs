...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    /// <summary>
    /// The public interface for PHAR
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(PHAR))]
    [XmlDefaultImplementationTypeAttribute(typeof(PHAR))]
    public interface IPHAR : IModelElement, IGroupP
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> HaRstChanging;
        
        /// <summary>
        /// Gets fired when the HaRst property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> HaRstChanged;
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> PhStopChanging;
        
        /// <summary>
        /// Gets fired when the PhStop property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> PhStopChanged;
