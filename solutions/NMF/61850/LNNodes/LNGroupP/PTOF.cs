...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    /// <summary>
    /// The default implementation of the PTOF class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PTOF")]
    public partial class PTOF : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPTOF, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new PTOFReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("Str")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("Op")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("BlkV")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("StrVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("BlkVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("OpDlTmms")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PTOF.ClassInstance)).Resolve("RsDlTmms")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the PTOF class
        /// </summary>
        public class PTOFReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private PTOF _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public PTOFReferencedElementsCollection(PTOF parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class StrProxy : ModelPropertyChange<IPTOF, IACD>
        {
            ...
            public StrProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class OpProxy : ModelPropertyChange<IPTOF, IACT>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public OpProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class BlkVProxy : ModelPropertyChange<IPTOF, ISPS>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public BlkVProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class StrValProxy : ModelPropertyChange<IPTOF, IASG>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StrValProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class BlkValProxy : ModelPropertyChange<IPTOF, IASG>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public BlkValProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class OpDlTmmsProxy : ModelPropertyChange<IPTOF, IING>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public OpDlTmmsProxy(IPTOF modelElement) : 
        ...
        /// </summary>
        private sealed class RsDlTmmsProxy : ModelPropertyChange<IPTOF, IING>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public RsDlTmmsProxy(IPTOF modelElement) : 
