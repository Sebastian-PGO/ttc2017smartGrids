...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PIOC")]
    public partial class PIOC : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPIOC, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(PIOC.ClassInstance)).Resolve("Str")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PIOC.ClassInstance)).Resolve("Op")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PIOC.ClassInstance)).Resolve("StrVal")));
        }
