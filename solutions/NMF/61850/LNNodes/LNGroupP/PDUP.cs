...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP
{
    ...
    /// <summary>
    /// The default implementation of the PDUP class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://www.transformation-tool-contest.eu/2017/smartGrids/substationStandard#//LN" +
        "Nodes/LNGroupP/PDUP")]
    public partial class PDUP : TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupP.GroupP, IPDUP, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new PDUPReferencedElementsCollection(this));
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("Str")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("Op")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("StrVal")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("OpDlTmms")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("RsDlTmms")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(PDUP.ClassInstance)).Resolve("DirMod")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the PDUP class
        /// </summary>
        public class PDUPReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private PDUP _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public PDUPReferencedElementsCollection(PDUP parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class StrProxy : ModelPropertyChange<IPDUP, IACD>
        {
            ...
            public StrProxy(IPDUP modelElement) : 
        ...
        /// </summary>
        private sealed class OpProxy : ModelPropertyChange<IPDUP, IACT>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public OpProxy(IPDUP modelElement) : 
        ...
        /// </summary>
        private sealed class StrValProxy : ModelPropertyChange<IPDUP, IASG>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public StrValProxy(IPDUP modelElement) : 
        ...
        /// </summary>
        private sealed class OpDlTmmsProxy : ModelPropertyChange<IPDUP, IING>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public OpDlTmmsProxy(IPDUP modelElement) : 
        ...
        /// </summary>
        private sealed class RsDlTmmsProxy : ModelPropertyChange<IPDUP, IING>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public RsDlTmmsProxy(IPDUP modelElement) : 
        ...
        /// </summary>
        private sealed class DirModProxy : ModelPropertyChange<IPDUP, IING>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public DirModProxy(IPDUP modelElement) : 
