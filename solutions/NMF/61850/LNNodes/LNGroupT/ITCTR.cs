...
namespace TTC2017.SmartGrids.SubstationStandard.LNNodes.LNGroupT
{
    ...
    /// <summary>
    /// The public interface for TCTR
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(TCTR))]
    [XmlDefaultImplementationTypeAttribute(typeof(TCTR))]
    public interface ITCTR : IModelElement, IGroupT
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ARtgChanging;
        
        /// <summary>
        /// Gets fired when the ARtg property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ARtgChanged;
    }
}
